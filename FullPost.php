  ...
  <?php } ?>
          ...
          <div class="card mt-4">
            <div class="card-body">
              ...
              <div class="text-center">
               <h4>ExtremeTech Newsletter</h4>
                Subscribe Today to get the latest ExtremeTech news delivered right to your inbox. This newsletter may contain advertising, deals, or affiliate links. Subscribing to a newsletter indicates your consent to our Terms of Use and Privacy Policy. You may unsubscribe from the newsletter at any time.
              </div>
            </div>
          </div>
          <br>
    ...
    <footer class="bg-dark text-white">
      <div class="container">
        <div class="row">
          <div class="col">
          <p class="lead text-center">Theme By | IQBAL | <span id="year"></span> &copy; ----All rights Reserved.</p>
